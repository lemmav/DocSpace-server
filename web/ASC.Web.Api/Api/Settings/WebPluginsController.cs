...
{
    [HttpPost("", Name = "addWebPluginFromFile")]
    ...
    [HttpGet("{name}", Name = "getWebPlugin")]
    ...
    [HttpPut("{name}", Name = "updateWebPlugin")]
    ...
    [HttpDelete("{name}", Name = "deleteWebPlugin")]
