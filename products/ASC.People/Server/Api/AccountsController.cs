...
{
    [HttpGet("room/{id}/search", Name = "getAccountsEntriesWithSharedAsync")]
        ...
        bool? excludeShared)
    {
        ...
        var totalUsers = await securityDao.GetUsersWithSharedCountAsync(room, text, employeeStatus, activationStatus, excludeShared ?? false);
