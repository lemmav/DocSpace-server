...
namespace ASC.Migrations.MySql.SaaS.Migrations
{
    ...
    public partial class MigrationContext_Upgrade22 : Migration
    {
        ...
        {
            migrationBuilder.Sql("ALTER TABLE webhooks_config MODIFY tenant_id INTEGER SIGNED NOT NULL;");
            migrationBuilder.Sql("ALTER TABLE webhooks_logs MODIFY tenant_id INTEGER SIGNED NOT NULL;");
